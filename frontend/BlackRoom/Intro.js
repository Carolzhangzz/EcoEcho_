...
function startGame() {
  ...
  const scenes = [
    ...
    },
    {
      text: {
        en: [
          "The discovery and development of a sustainable energy source called T have fundamentally transformed human society.",
          "As a clean energy source from Mars, T energy effectively resolved Earth's energy crisis and significantly reduced dependence on traditional polluting energy sources.",
        ...
        zh: [
          "一种叫T的可持续能源的发现和开发彻底改变了人类社会。",
          "作为一种来自火星的清洁能源, T能源不仅有效解决了地球的能源危机, 还显著减少了对传统污染性能源的依赖。",
    ...
    },
    {
      text: {
        en: [
          ...
          "Suddenly, he remembered the recently developed and still classified time machine at his lab. Although it could only go back ten years, it might be his chance to return to the past, obtain gasoline, and possibly eliminate the development of energy T, seeking justice for his father's death.",
          "He took a deep breath, preparing to embark on the adventure.",
        ],
        zh: [
          "KI感到深深的怀念和伤感, 他太想念父亲了, 想要启动这辆旧车, 仿佛这样就可以把那些美好的旧时光带回来。",
          "突然,他想起了实验室最近研发的、仍在保密阶段的时光机器。虽然这台时光机器只能回到十年前, 但这也许是一个机会, 让他能够回到过去, 重新获得石油, 同时找到机会阻止能源T的开发, 为父亲的死讨回公道。",
          "他深吸一口气，准备踏上冒险。",
        ],
      },
